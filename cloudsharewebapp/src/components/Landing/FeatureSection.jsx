import { ArrowUpCircle, CreditCard, FileText, Shield, Share2, Clock } from "lucide-react";
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center">
                    ...
                    <p className="mt-4 max-w-2xl mx-auto text-xl text-gray-500">
                        CloudShare provide all the tools you need to manage your digital content
                    </p>
                </div>
                <div className="mt-16">
